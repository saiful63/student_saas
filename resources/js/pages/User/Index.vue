                    ...
                    <tbody>
                        <tr v-for="user in users" class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 space-x-2">
                                <Link :href="`users/${user.id}`"class="bg-gray-500 text-white px-2 py-1 rounded pointer">Show</Link>
                                <Link :href="`users/${user.id}/edit`"class="bg-blue-500 text-white px-2 py-1 rounded pointer">Edit</Link>
